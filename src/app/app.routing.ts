...
export const appRoutes: Route[] = [
    ...
    { path: '', pathMatch: 'full', redirectTo: 'projeto/main' },
    ...
    { path: 'signed-in-redirect', pathMatch: 'full', redirectTo: 'projeto/main' },
        ...
        children: [
            ...
            },
            {
                path: 'projeto', children: [
                    ...
                    { path: 'alter-pet', loadChildren: () => import('app/modules/admin/project/perfil/alter-pet/alter-pet.module').then(m => m.AlterPetModule) },
                ]
            },
